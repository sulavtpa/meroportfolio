...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const headerTerminalButton = document.getElementById(
  ...
  const terminalCloseButton = terminalWindow.querySelector(
  ...
  const taglinePhrases = [
    "A passionate BE Computer Student",
    "A Sandbox Lover",
    "A C/C++ Dev",
    "A Web Developer",
    "A Book Enjoyer",
  ...
  const openMobileMenu = () => {
    ...
    gsap.from(mobileMenuOverlay.querySelectorAll("a"), {
      y: 20,
      opacity: 0,
      stagger: 0.1,
      duration: 0.5,
